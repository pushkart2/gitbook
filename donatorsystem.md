...
- Before starting the script, make sure to change the keybinds if you wish to change them.

# Changes for qb-inventory (latest only)
...
# Available TimeZones Value (Config.DailyShop.time_zone)
```js
'Europe/Andorra',
  'Asia/Dubai',
  'Asia/Kabul',
